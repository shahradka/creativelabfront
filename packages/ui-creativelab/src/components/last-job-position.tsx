...
export const LastJobPosition = () => {
  return (
    <Typography className="font-lora text-white italic text-center py-20 px-30 bg-white/10 leading-13 z-1 rounded-2xl border border-white/20 backdrop-blur-sm">
